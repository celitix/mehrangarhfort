      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mt-10 ">
          <h2 className="text-5xl md:text-6xl font-bold text-slate-900 mb-6 ">
            Discover Blogs That
            <span className="leading-18 text-4xl md:text-5xl block bg-gradient-to-r from-[#EDD391] to-[#daa520] bg-clip-text text-transparent">
              Captivate & Inform
            </span>
          </h2>
        </div>
            ...
            <Link href={`/blog/${blog.slug}`} key={blog.id}>
              <article className="group rounded-2xl border border-slate-200 overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer transform hover:-translate-y-2">
                <div className="relative h-56 overflow-hidden">
                  <div className={`absolute inset-0 bg-gradient-to-br ${blog.gradient} opacity-90`} />
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-slate-100">
                    ...
                    <span className="flex items-center text-[#daa520] font-semibold">
                      Read More
